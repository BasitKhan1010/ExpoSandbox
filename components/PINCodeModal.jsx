...
const PINCodeModal = ({ isModalVisible, toggleModal, pinLength, pin, setPin, source }) => {
    const inputs = useRef([]);
            ...
            if (confirmPinInput.every((digit) => digit !== '')) {
                if (pin.join('') === confirmPinInput.join('')) {
                    ...
                    if (source === 'fingerprint') {
                        router.push('/register-fingerprint');
                    } else if (source === 'face') {
                        router.push('/register-faceid');
                    }
                } else {
                ...
                Alert.alert('Error', 'Please enter all 4 digits of the confirm PIN.');
            }
        } else {
